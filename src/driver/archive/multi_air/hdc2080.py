# # HDC 2080 Temperature Humidity Sensor
...
class Pi_HDC2080:
        ...
        def readTemperature(self):
                ...
                time.sleep(0.01)  #wait for measure to be done            
...
if __name__ == '__main__':
    hdc2000 = Pi_HDC2080(twi=1)
    while True:
        print('{temp:.2f}\t{hum:.2f}'.format(
            temp=hdc2000.readTemperature(),
            hum=hdc2000.readHumidity()
            ))
